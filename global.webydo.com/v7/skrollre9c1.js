    ...
    Skrollr.prototype.refresh = function (elements)
    {
        ...
        for (; elementIndex < elementsLength; elementIndex++)
        {
            ...
            for (; keyFrameIndex < keyFramesLength; keyFrameIndex++)
            {
                ...
                {
                    //i had to clone sk.keyFrames[1], otherwise changing it's position to 'fixed' somehow change sk.keyFrames[0] position to 'fix'
                    var clonedAnchorFrame = $.extend(true, {}, sk.keyFrames[1])
                    clonedAnchorFrame.props['position'].value[0] = 'fixed';
                ...
                if (delay && delay > 0)
                {
                    currFrame.props['position'].value[0] = 'fixed';
